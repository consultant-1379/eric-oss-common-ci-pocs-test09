...
*/ -}}
{{- define "eric-oss-common-ci-pocs-test09.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-common-ci-pocs-test09.mergeAnnotations" -}}
  {{- include "eric-oss-common-ci-pocs-test09.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-common-ci-pocs-test09.mergeLabels" -}}
  {{- include "eric-oss-common-ci-pocs-test09.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
